...
var linuxtreeinit = false;

Reveal.addEventListener('linuxtree', function() {
    if (!linuxtreeinit) {
	var sys = arbor.ParticleSystem(1000, 600, 0.5) // create the system with sensible repulsion/stiffness/friction
//	sys.parameters({gravity:true}) // use center-gravity to make the graph settle nicely (ymmv)
	sys.renderer = Renderer("#linuxview") // our newly created renderer will have its .init() method called shortly by sys...
